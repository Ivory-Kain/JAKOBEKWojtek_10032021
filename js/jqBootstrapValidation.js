      ...
      ajax: {
		...
		builtInValidators: {
			...
			integer: {
				...
				type: "regex",
				regex: "[+-]?\\\d+",
				message: "Pas de décimale autorisée<!-- data-validator-integer-message to override -->"
			},
			positivenumber: {
				name: "Positivenumber",
				type: "min",
			...
			checkone: {
				...
				type: "minchecked",
				minchecked: 1,
				message: "Cocher au moins une option<!-- data-validation-checkone-message to override -->"
			}
		}
	};
